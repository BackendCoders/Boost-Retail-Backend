...
namespace Boost.Admin.Logic
{
    public class ImportLogic : IImportLogic
    {
        ...
        public async Task<List<Boost.Admin.Data.Models.Specification>> GetOrInsertSpecs(List<string> tocheck)
        {
            // Use a HashSet to store the names of that already exist
            ...
            // Create new entities for the new tag names
            var newItems = newNames.Select(name => new Boost.Admin.Data.Models.Specification { SpecificationJson = name }).ToList();
        ...
        public async Task<List<Boost.Admin.Data.Models.Geometry>> GetOrInsertGeos(List<string> tocheck)
        {
            // Use a HashSet to store the names of that already exist
            ...
            // Create new entities for the new tag names
            var newItems = newNames.Select(name => new Boost.Admin.Data.Models.Geometry { GeometryJson = name }).ToList();
        ...
        public async Task Save(Boost.Admin.Data.Models.Catalog.MasterProduct product)
        {
