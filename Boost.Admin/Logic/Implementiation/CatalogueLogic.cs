...
namespace Boost.Admin.Logic
{
    public class CatalogueLogic : LogicBase, ICatalogueLogic
    {
        ...
        public async Task<LogicResult<SIMProductDto>> GetProductByMpn(string mpn)
        {
            ...
            if (obj != null)
            {
                var res = _mapper.Map<CatalogueItem, SIMProductDto>(obj);
                return LogicResult.Ok(res);
            }

            return (LogicResult<SIMProductDto>)LogicResult.Fail("mpn not found");

            
        }

        public async Task<LogicResult<SIMProductsDto>> GetProductsByMpnBulk(List<string> mpns)
        {
            if (mpns.Count == 0)
                return LogicResult.Fail<SIMProductsDto>("no mpns provided");
            else
            {
                var exists = await Exists(mpns);

                var obj = new SIMProductsDto();
                ...
                foreach (var mpn in exists.Found)
                {
                    ...
                    if (obj1 != null)
                    {
                        var res = _mapper.Map<CatalogueItem, SIMProductDto>(obj1);
                        lst.Add(res);
                    }
                }
        ...
        public async Task<List<SIMProductDto>> GetProductsBySupplier(DataSupplier supplier)
        {
            var lst = new List<SIMProductDto>();
            ...
            if (obj != null)
            {
                ...
                {
                    var res = _mapper.Map<CatalogueItem, SIMProductDto>(item);
                    lst.Add(res);
                }
            }
        ...
        public async Task<List<SIMProductDto>> GetProductsBySupplierAndType(DataSupplier supplier, ProductType type)
        {
            var lst = new List<SIMProductDto>();
        ...
        public async Task<List<SIMProductDto>> GetProductsBySupplier(DataSupplier supplier, int year)
        {
            var lst = new List<SIMProductDto>();
        ...
        public async Task<List<SIMProductDto>> GetProductsBySupplierBrandByYear(DataSupplier supplier, string brand, int skip, int take, string year)
        {
            var lst = new List<SIMProductDto>();
        ...
        public async Task<List<SIMProductDto>> GetProductsBySupplierYearKeyword(DataSupplier supplier, int skip, int take, string keyword, string year)
        {
            var lst = new List<SIMProductDto>();
            var valid = int.TryParse(year, out var yr);
        ...
        public async Task<List<SIMProductDto>> GetProductsBySupplierYearKeywordBrand(DataSupplier supplier, string brand, int skip, int take, string keyword, string year)
        {
            var lst = new List<SIMProductDto>();
            var valid = int.TryParse(year, out var yr);
        ...
        public async Task<List<SIMProductDto>> GetProductsBySupplierYearPaged(DataSupplier supplier, int skip, int take, string year)
        {
            var lst = new List<SIMProductDto>();
            var valid = int.TryParse(year, out var yr);
        ...
        public async Task<List<SIMProductDto>> GetProductsByYearKeyword(int skip, int take, string keyword, string year)
        {
            var valid = int.TryParse(year, out var yr);
