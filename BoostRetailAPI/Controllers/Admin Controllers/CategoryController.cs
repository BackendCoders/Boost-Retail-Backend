...
namespace BoostRetailAPI.Controllers.Admin_Controllers
{
    ...
    public class CategoryController : ControllerBase
    {
        ...
        [HttpDelete("DeleteCategoryMapAsync/{id}")]
        public async Task<IActionResult> DeleteCategoryMapAsync(int id)
        {
            try
            {
                var res = await _logic.DeleteCategoryMapAsync(id);
                return Ok(res);
            }
            catch (KeyNotFoundException)
            {
        ...
        [HttpPost, Route("SaveCategoryMapAsync")]
        public async Task<IActionResult> SaveCategoryMapAsync([FromBody] CategoryMapRequestdto request,int Tableid)
        {
            var id = await _logic.SaveCategoryMapAsync(request,Tableid);
            return Ok(new { Id = id });
        }
