...
namespace BoostRetailAPI.Controllers
{
    ...
    public class CatalogueController : ControllerBase
    {
        ...
        public async Task<List<SIMProductDto>> GetProductsBySupplier([FromQuery] DataSupplier supplier, int year)
        {
            return await _logic.GetProductsBySupplier(supplier, year);
        }

        [HttpGet, Route("ProductsBySupplierBrandYear")]
        public async Task<List<SIMProductDto>> GetProductsBySupplierBrandByYear([FromQuery] DataSupplier supplier, string brand, int skip, int take, string year)
        {
        ...
        public async Task<List<SIMProductDto>> GetProductsBySupplierYearKeyword([FromQuery] DataSupplier supplier, int skip, int take, string keyword, string year)
        {
        ...
        public async Task<List<SIMProductDto>> GetProductsBySupplierYearKeywordBrand([FromQuery] DataSupplier supplier, string brand, int skip, int take, string keyword, string year)
        {
        ...
        public async Task<List<SIMProductDto>> GetProductsBySupplierYearPaged([FromQuery] DataSupplier supplier, int skip, int take, string year)
        {
            return await _logic.GetProductsBySupplierYearPaged(supplier, skip, take, year);
        }

        [HttpGet, Route("ProductsByYearKeyword")]
        public async Task<List<SIMProductDto>> GetProductsByYearKeyword([FromQuery] int skip, int take, string keyword, string year)
        {
